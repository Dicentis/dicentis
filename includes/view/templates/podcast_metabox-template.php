<div class="metabox-tabs-div">
	...
	<ul id="metabox-tabs" class="metabox-tabs">
		<li class="active dipo_tab_mediafiles">
			<a class="active" href="javascript:void(null);"><?php _e( 'Mediafiles', $this->textdomain ); ?></a>
		</li>
		<li class="dipo_tab_supplementary">
			<a href="javascript:void(null);"><?php _e( 'Supplementary Information', $this->textdomain ); ?></a>
		</li>
	</ul>
